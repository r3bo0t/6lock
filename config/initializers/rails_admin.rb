# RailsAdmin config file. Generated on August 18, 2012 21:20
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Sixlock', 'Admin']
  ...
  # config.excluded_models = [Folder, Record, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Folder, Record, User]
